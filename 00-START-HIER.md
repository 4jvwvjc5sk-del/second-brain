# Start hier — Second Brain Index

#second-brain #claude-code #session-start

Lies diese Datei am Anfang jeder neuen Session.

## Was ist das Second Brain?
Persistentes Wissen, das über Sessions hinweg erhalten bleibt. → [[Konzepte/second-brain-system]]
Claude liest nur was relevant ist — nicht alles auf einmal.

## Dateien in diesem Second Brain
...
| Konzept | Inhalt |
|---------|--------|
| [[Konzepte/second-brain-system]] | Wie das System funktioniert |
| [[Konzepte/token-sparen]] | Token-Sparstrategien |
| [[Konzepte/mcp-server]] | MCP Server Regeln |
| [[Konzepte/parallel-sessions]] | Mehrere Sessions gleichzeitig |
...
2. Relevante Projektdatei aus [[Projekte/]] lesen
3. Am Ende der Aufgabe: neue Erkenntnisse ins Second Brain schreiben
4. Vor `/compact`: wichtige Infos sichern → [[workflows]]
5. Dann neue Session starten
